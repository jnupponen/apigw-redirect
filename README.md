...
This is a sample template for apigw-redirect - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name apigw-redirect --tail
```
...
```bash
aws cloudformation delete-stack --stack-name apigw-redirect
```
